          ...
          {courses.map((course: Course) => (
            ...
            >
              <div className="h-48 sm:h-56 bg-[var(--primary)] relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--primary)] via-[var(--primary)]/60 to-transparent opacity-70 pointer-events-none"></div>
              ...
              <div className="p-4 sm:p-6">
                ...
                <a
                  href="#apply"
                  className="mt-4 sm:mt-6 inline-flex items-center gap-2 py-2 px-1 -mx-1 text-[var(--gold)] hover:text-[var(--text-dark)] transition-colors font-medium text-sm sm:text-base group/button"
                >
                  Learn more
